...
<div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="md-3 text-black">Get In Touch</h2>
                </div>
                <div class="col-md-7 ml-auto mr-auto">
                    <form action="contact.php" method="post">
                        <div class="p-3 p-lg-5 border">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="messege" class="text-black">Messege<span class="text-danger">*</span></label>
                                    <textarea name="messege" id="messege" cols="30" rows="7" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <input type="submit" class="btn btn-primary btn-lg btn-block"  name="send" value="Send Messege">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-md-5 ml-auto">
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">Kyiv</span>
                        <p class="mb-0">303 Fake St. Hostel 7 View, Soloma, Kyiv, UA</p>
                    </div>
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">Lviv</span>
                        <p class="mb-0">303 Fake St. Hostel 7 View, Soloma, Kyiv, UA</p>
                    </div>
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">Zutomur</span>
                        <p class="mb-0">303 Fake St. Hostel 7 View, Soloma, Kyiv, UA</p>
                    </div>
                </div>
        <?
                    }else if (isset($_POST['send']) && !empty($_POST['name']) && !empty($_POST['lname'])&& !empty($_POST['email']) && !empty($_POST['messege'])){
                        $query="Insert into messege (name, lname, mail, messege) VALUE ('".$_POST['name']."', '".$_POST['lname']."', '".$_POST['email']."', '".$_POST['messege']."')";
                        mysqli_query($dbc, $query) or die("error 404");
                    echo "<div class='col-md-12 text-center'>
            <span class='icon-check_circle display-3 text-success'></span>
            <h2 class='display-3 text-black'>Thank you!</h2>
            <p class='lead mb-5'>Your message has been successfully sent.</p>
            ...
            <h2 class='display-3 text-warning'>Error 404</h2>
             <p class='lead mb-5'>Not enough data</p>
                <p><a href='contact.php' class='btn btn-sm btn-primary'>Back to contact</a></p>
        </div>";
        mysqli_close($dbc);
    }
                    ?>
