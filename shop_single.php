...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop single</strong></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                if (isset($_GET['id']) && !empty($_GET['id'])){
                    $query="Select id, model, price, dat, probeg, count,  photo, cat, comment from towar WHERE id=".$_GET['id'];
                    ...
                    $rezult1=mysqli_query($dbc, $query1) or die("error");
                    $next1=mysqli_fetch_array($rezult1);
                }
                ?>
                <div class="col-md-6">
                    <img src="images/towar/<?=$photo?>" alt="Image" class="img-fluid">
                </div>
                <div class="col-md-6">
                    <h2 class="text-black"><?=$next['model']?></h2>
                    <h4 class="text-primary"><?=$next1['cat']?></h4>
                    <p class="text-info">Prodaction year - <?=$next['dat']?>.<br> Probeg - <?=$next['probeg']?> km.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur, vitae, explicabo? Incidunt facere, natus soluta dolores iusto! Molestiae expedita veritatis nesciunt doloremque sint asperiores fuga voluptas, distinctio, aperiam, ratione dolore.</p>
                    <span class="text-primary"> <?=$next['comment']?> </span>
                    <p class="mb-4">Ex numquam veritatis debitis minima quo error quam eos dolorum quidem perferendis. Quos repellat dignissimos minus, eveniet nam voluptatibus molestias omnis reiciendis perspiciatis illum hic magni iste, velit aperiam quis.</p>
                    <p><strong class="text-primary h4"><?=$next['price']?>$</strong></p>
                        <?
                        if ($next['count']<1){
                            echo "<div class='mb-5'><p><strong class='text-warning h5'>Not in stock</strong></p></div>";
                        }else{
                            echo "<p><a href='basket.php?id=".$next['id']."&mode=add' class='btn btn-sm btn-primary'>Add To Basket</a></p>";
                        }
                        ?>
                </div>
            </div>
