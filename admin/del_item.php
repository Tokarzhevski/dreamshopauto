...
if (isset($_SESSION['adminid']) && isset($_SESSION['adminlogin']) && isset($_SESSION['adminawatar']) && isset($_SESSION['admincont'])){
    ...
    <div class="site-wrap">
        ...
        <div class="col-md-6 ml-auto mr-auto mb-4 text-center forma">
            <h2 class="h3 mb-3 text-info text-center">Do you really want to delete <span class="text-warning"><?=$model?></span></h2>
            <form action="del_item.php" method="post" enctype="multipart/form-data">
            ...
            <?
                ...
                $query1="DELETE FROM towar WHERE id=$id";
                mysqli_query($dbc, $query1) or die ("errror1");
                echo "<h2 class='md-3 text-info text-center'>Item ".$_GET['model']." successfully deleted<br><a href='control_item.php' class='text-success'>Back</a></h2>";
                mysqli_close($dbc);
            }else if (isset($_POST['no'])) {
                header("location:control_item.php");
        }else {
                echo "<h3 class='md-3 text-danger text-center'>Error!  Try again <a href='control_item.php' class='text-success'>Back</a></h3>";
            }
            ?>
        </div>
    </div>
